...
import type { EditorThemeDef } from '../hooks/useEditorTheme';

interface Props {
  readonly themes: readonly EditorThemeDef[];
  readonly activeId: string;
  readonly onSelect: (id: string) => void;
}

export default function EditorThemePicker({ themes, activeId, onSelect }: Props) {
          ...
          {themes.map((theme) => (
            ...
            >
              <span
                ...
                style={{ background: theme.colors['editor.background'] ?? (theme.base === 'vs-dark' ? '#1e1e1e' : '#ffffff') }}
              />
