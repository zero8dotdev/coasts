...
export default function HostServiceLogsTab({ project, service }: Props) {
  ...
  useEffect(() => {
    ...
    const url = `${protocol}//${window.location.host}/api/v1/host-service/logs?project=${encodeURIComponent(project)}&service=${encodeURIComponent(service)}`;
